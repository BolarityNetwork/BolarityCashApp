  ...
  return (
    <CommonSafeAreaView className="flex-1 bg-gray-50">
      ...
      <View className="flex-row items-center justify-between px-5 py-4 pt-15 bg-white">
        ...
        <Text className="text-xl font-bold text-gray-900">NFTs</Text>
        <View className="w-10" />
      </View>
        ...
        <View className="mt-8">
          <View className="bg-white rounded-2xl p-6 shadow-sm">
            <View className="items-center py-10">
              ...
              <Text className="text-xl font-bold text-gray-900 mb-2">NFTs</Text>
              <Text className="text-gray-500 text-center leading-6">
                This page is under development.{'\n'}
                You'll be able to manage your NFT collection here.
              </Text>
            </View>
          </View>
        </View>
